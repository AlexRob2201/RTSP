...
################################################################################
## Form generated from reading UI file 'ui_main_work_no_page – копія.ui'
##
...
"")
        ...
        self.add_device_1.setCheckable(True)
        self.add_device_1.setAutoExclusive(True)
        ...
        self.verticalLayout_4 = QVBoxLayout(self.add_device_page)
        ...
        self.verticalLayout_3.setContentsMargins(10, 15, 10, -1)
...
"}")
        ...
        self.verticalSpacer_5 = QSpacerItem(20, 28, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
...
"height: 45;")
        ...
        icon8 = QIcon()
        icon8.addFile(u":/img/cursor.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.select_folder.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/img/save.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.add_new_device_button.setIcon(icon9)
